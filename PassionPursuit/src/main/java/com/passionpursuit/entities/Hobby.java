...
public class Hobby extends BaseEntity {
	...
	public String toString() {
		return "Hobby [name=" + name + ", slogan=" + slogan + ", intro=" + intro + ", description=" + description
				+ ", category=" + category + ", creator=" + creator + ", price=" + price + ", location=" + location
				+ ", profileImgUrl=" + profileImgUrl + ", galleryImgUrl1=" + galleryImgUrl1 + ", galleryImgUrl2="
				+ galleryImgUrl2 + ", galleryImgUrl3=" + galleryImgUrl3 + ", profileImg_id=" + profileImg_id
				+ ", galleryImg1_id=" + galleryImg1_id + ", galleryImg2_id=" + galleryImg2_id + ", galleryImg3_id="
				+ galleryImg3_id + ", contactInfo=" + contactInfo + "]";
	}
