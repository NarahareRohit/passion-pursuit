...
import com.passionpursuit.entities.*;
...
import com.passionpursuit.repostiory.AppClientRepository;
import com.passionpursuit.repostiory.BusinessOwnerRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<UserEntity> saveUsersAndUserRoles() {
        ...
        if (appClientRepository.count() == 0) {
            ...
            user.setEmail("aniketgadage@gmail.com");
            user.setPassword(this.passwordEncoder.encode("Aniket@123"));
            user.setRoles(List.of(userRole));
            user.setFullName("Aniket Gadage");
        ...
        if (businessOwnerRepository.count() == 0) {
            ...
            business_user.setEmail("Rohit000reddy@gmail.com");
            business_user.setPassword(this.passwordEncoder.encode("Rohit@123"));
            business_user.setRoles(List.of(businessRole));
            business_user.setBusinessName("test Business name");
            business_user.setAddress("test business address");
