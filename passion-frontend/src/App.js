...
import Subscriptionuser from "./components/root/users/user/Subscriptionuser";
import Payment from "./components/root/users/user/Payment";
import Subscriptionbizz from "./components/root/users/business/Subscriptionbizz";
import Otpvalidation from "./components/root/users/Otpvalidation";
      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoutesBusiness />}>
            ...
            <Route path="/Subscriptionbizz" element={<Subscriptionbizz/>}/>

            <Route path="/Paymentbizz" element={<Payment/>}/>
          </Route>
        </Routes>
      </div>
    </Router>
