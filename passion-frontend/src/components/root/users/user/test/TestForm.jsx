  ...
  const questions = [
    {
      ...
      value: "categoryOne",
      answerOptions: [
        { answerText: "Playing Games", category: "FUN" },
    ...
    },
    {
      ...
      answerOptions: [
        ...
        { answerText: "Other", category: "MUSIC" },
      ],
    },
    {
    ...
    },
    {
      ...
      value: "location",
      answerOptions: [
        { answerText: "AKURDI", category: "AKURDI" },
        { answerText: "BHOSRI", category: "BHOSRI" },
        { answerText: "HADAPSAR", category: "HADAPSAR" },
        { answerText: "KOTHRUD", category: "KOTHRUD" },
      ],
    },
  ];
