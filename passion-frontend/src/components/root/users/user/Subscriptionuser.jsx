...
const Subscriptionuser = () => {
  ...
  <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
    <div class="col">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">99 Rs <small class="text-muted">/ mo</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li>10 call included</li>
    ...
    <div class="col">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">999 Rs<small class="text-muted">/ mo</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li>50 call included</li>
          <li>Next subscription 25% off</li>
          <li>Priority email support</li>
          <li>Help center access</li>
        </ul>
        <Link to="/Payment" state={999}>
        <button type="button" class="w-100 btn btn-lg btn-primary">Get started</button>
        </Link>
      </div>
    </div>
    ...
    <div class="col">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">9999 Rs<small class="text-muted">/ mo</small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li>100 call included</li>
          <li>Next subscription 50% off</li>
          <li>Phone and email support</li>
          <li>Help center access</li>
        </ul>
        <Link to="/Payment" state={9999}>
        <button type="button" class="w-100 btn btn-lg btn-primary">Get started</button>
        </Link>
      </div>
    </div>
