...
//import Logo from "../../root/fragments/header/logo/Logo"
...
const UserHome = () => 
{
  ...
  const handleSort = (value) => (event) => {
    ...
    console.log(isUserLoggedIn+" "+isBusinessLoggedIn);
    if (isUserLoggedIn) {
                  ...
                  >
                    ...
                    <section className={styles.card_content}>
                      ...
                      <div className={styles.card_info}>
                        <p className={styles.text_medium}>Get More Info...</p>
                        <p className={styles.card_price}>{hobby.price} Rs</p>
                      </div>
                    </section>
                  </Link>
                </div>
